    ...
    >
      ...
      >
        ...
        <div
          className={`p-6 border-b ${
            theme === "dark"
              ? "border-gray-700 bg-gradient-to-r from-blue-600 to-blue-700"
              : "border-gray-100 bg-gradient-to-r from-blue-500 to-blue-600"
          }`}
        >
          <h1 className="font-bold text-xl text-white tracking-wide">
            User Panel
          </h1>
          <p className="text-blue-100 text-sm mt-1">Your Dashboard</p>
        </div>
      ...
      <div className="flex-1 flex flex-col ml-64">
        ...
        <header
          ...
          } shadow-lg border-b px-6 py-4 flex justify-between items-center z-30`}
        >
