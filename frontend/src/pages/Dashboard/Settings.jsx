...
export default function AdminSettings() {
  ...
  return (
    <div className={`min-h-screen ${settings.theme === 'dark' ? 'dark bg-gray-900' : 'bg-gray-50'}`}>
        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <button className={`p-2 hover:${settings.theme === 'dark' ? 'bg-gray-700' : 'bg-gray-100'} rounded-lg transition-colors`}>
                <ChevronLeft className={`w-5 h-5 ${settings.theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`} />
              </button>
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className={`text-xl font-bold ${settings.theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>Admin Settings</h1>
                  <p className={`text-sm ${settings.theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>Manage your dashboard preferences</p>
                </div>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              <button 
                ...
                className={`flex items-center px-4 py-2 ${settings.theme === 'dark' ? 'text-gray-300 hover:text-white hover:bg-gray-700' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-100'} rounded-lg transition-colors`}
              >
      ...
      <div className="flex">
        {/* Sidebar */}
        <div className={`w-64 ${settings.theme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} border-r min-h-screen`}>
          <div className="p-4">
        ...
        {/* Main Content */}
        <div className={`flex-1 p-6 ${settings.theme === 'dark' ? 'bg-gray-900' : ''}`}>
          <div className="max-w-4xl mx-auto">
            ...
            {activeTab === 'appearance' && (
              <div className="space-y-6">
                <div>
                  <h2 className={`text-2xl font-bold ${settings.theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-2`}>Appearance</h2>
                  <p className={`${settings.theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>Customize how your dashboard looks and feels</p>
                </div>

                <div className={`${settings.theme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} rounded-lg border p-6`}>
                  <h3 className={`text-lg font-semibold ${settings.theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-4`}>Theme</h3>
                    ...
                    {[
                      ...
                      >
                        <theme.icon className={`w-8 h-8 mx-auto mb-2 ${
                          settings.theme === theme.id ? 'text-green-600' : 
                          settings.theme === 'dark' ? 'text-gray-400' : 'text-gray-400'
                        }`} />
                        <div className="text-center">
                          <div className={`font-medium ${settings.theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>{theme.label}</div>
                          <div className={`text-sm ${settings.theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>{theme.desc}</div>
                        </div>
                      </button>
                    ))}
                  </div>
            ...
            {activeTab === 'notifications' && (
              <div className="space-y-6">
                <div>
                  <h2 className={`text-2xl font-bold ${settings.theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-2`}>Notifications</h2>
                  <p className={`${settings.theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>Control what notifications you receive</p>
                </div>
                ...
                <div className={`${settings.theme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} rounded-lg border p-6`}>
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={notification.key} className={`flex items-center justify-between p-4 border ${settings.theme === 'dark' ? 'border-gray-700' : 'border-gray-200'} rounded-lg`}>
                        <div className="flex items-center space-x-3">
                          <notification.icon className={`w-5 h-5 ${settings.theme === 'dark' ? 'text-gray-400' : 'text-gray-400'}`} />
                          <div>
                            <div className={`font-medium ${settings.theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>{notification.label}</div>
                            <div className={`text-sm ${settings.theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>{notification.desc}</div>
                          </div>
                        </div>
            ...
            {activeTab === 'system' && (
              <div className="space-y-6">
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 mb-2">System</h2>
            ...
            {activeTab === 'display' && (
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-600">Customize what appears on your dashboard</p>
                </div>
